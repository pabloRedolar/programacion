...
public class Principal {
    ...
    public static final int MOSTRAR_PRODUCTOS_PRECIO_MAYOR = 8;
    ...
    public static void mostrarMenu() {
        ...
        System.out.println("8.-  Muestra producto con precio mayor a X");
...
//                    productoAux.alta();
                ...
                case MOSTRAR_PRODUCTOS_PRECIO_MAYOR: {
                    System.out.println("Productos con precio mayor al indicado");
                    ListaProductos listaProductos = new ListaProductos();
                    listaProductos.buscarProductoPorPrecio();
                }
